package com.example.fabio.udacity_bookstoreapp.data;
...
public final class BookContract {
    ...
    public static final class BookEntry implements BaseColumns {
         ...
         * Type: TEXT
         */
        public final static String COLUMN_BOOK_SUPP_NAME ="supp_name";
         ...
         * Type: TEXT
         */
        public final static String COLUMN_BOOK_SUPP_PHONE ="supp_phone";

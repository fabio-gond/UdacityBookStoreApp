...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void saveBook() {
        ...
        values.put(BookEntry.COLUMN_BOOK_SUPP_NAME, suppNameString);
        values.put(BookEntry.COLUMN_BOOK_SUPP_PHONE, suppPhoneString);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                BookEntry.COLUMN_BOOK_SUPP_PHONE};
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int suppPhoneColumnIndex = cursor.getColumnIndex(BookEntry.COLUMN_BOOK_SUPP_PHONE);
